...
namespace DocExplorer.Resources {
    public partial class AboutDocExplore : Form {
        public AboutDocExplore() {
            ...
            label1.Text = String.Format(label1.Text, devEnv.Settings.ProductVersionRelease.ToString(2), devEnv.Settings.ProductVersionCodebase + "-" + devEnv.Settings.ProductBuildStage + " (" + devEnv.Settings.ProductBuildLab + ")", DevEnvVersion.FullVersion + " (" + DevEnvVersion.BuildLab + ")");
