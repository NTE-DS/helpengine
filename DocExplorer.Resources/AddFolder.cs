...
namespace DocExplorer.Resources
{
	internal class AddFolder : Form
	{
		...
		internal AddFolder(FavoriteFolder favoriteFolder)
		{
		...
		private void button1_Click(object sender, System.EventArgs e)
		{
			...
			{
				if ((
					from v in this._favoriteFolder.SubFolders
					where v.Title == this.textBox1.Text
					select v).Count<FavoriteFolder>() == 0)
				{
					this._favoriteFolder.SubFolders.Add(new FavoriteFolder
					{
